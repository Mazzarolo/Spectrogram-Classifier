...
class ProcessWineData:
  ...
  def __init__(self, mean_rows=5):
    ...
    x_w5, y_w5 = process_file(r'wine/Clean_W5.csv', baseline="nan", glass="nan", fluorescence="nan", mean_rows=mean_rows)
    ...
    self.x_full_dataset = np.concatenate([y_w1.T.values,y_w2.T.values,y_w3.T.values,y_w4.T.values,y_w5.T.values])
    self.y_full_dataset = np.concatenate([true_y_w1,true_y_w2,true_y_w3,true_y_w4,true_y_w5])
